...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Plus(x1)) {
      ...
      var x6 = $as_Lcalculator_Literal(x1);
      var v = x6.v$2;
      return v
    } else if ($is_Lcalculator_Ref(x1)) {
      var x7 = $as_Lcalculator_Ref(x1);
      var varName = x7.name$2;
      var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(varName, references);
      var this$1 = references;
      var temp$references = $as_sci_Map(this$1.removed__O__sci_MapOps(varName));
      expr = temp$expr;
